...
import { IconAnsweredCall } from '../../common/icons/answeredicon';
          ...
          {/* {loading ? ( // Use the loading state here to conditionally render the ActivityIndicator
            ...
            data.map((post) => ( */}
              ...
              >
                ...
                <View style={{position:"absolute",right:"2%",flexDirection:"row",justifyContent:"center"}}><Text  style={{color:"rgba(101, 101, 101, 1)",fontSize:10,fontWeight:"400",margin:8}}>5:30</Text><IconAnsweredCall/></View>
              </View>
        </View>
      </View>
    </ScrollView>
